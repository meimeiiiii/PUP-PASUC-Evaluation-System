...
<%
	...
	if (session.getAttribute("faculty")==null && session.getAttribute("empId")==null && session.getAttribute("email")==null){
		if(request.getParameter("emailLog")!=null){
			...
			System.out.println("[ABOUT] Direct to ABOUT, Redirect to INDEX");
		...
		<div class="col-xl-12" style="margin-top: 100px;">
 			...
 			<!-- <div class="tab-regular">
    			 <ul class="nav nav-tabs nav-fill">
               		...
               		<li>
                    	<button class="nav-link btn-block"  href="home-profile">Profile</button>
                 	</li>
                 	</div>
                 	...
                 	<div style="width: 24.5%; margin-left: 6px;">
                 	<li>
                		<button class="nav-link  active btn-block"  href="home-about">About PUP PASUC</button>
     	            </li>
     	            </div>
 				</ul> -->
    			 ...
    			 <ul class="nav nav-tabs nav-fill" role="tablist">
	                ...
	                <li class="nav-item">
     	            ...
     	            <li class="nav-item">
                		<a class="nav-link active"  href="about">About PUP PASUC</a>
     	            </li>
 				</ul>
 	<!-- ============================================================== -->
	<!-- END TOP NAV  -->
